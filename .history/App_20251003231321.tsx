...
const InvitationSection: React.FC = () => (
    <Section className="py-16 px-6 text-center max-w-4xl mx-auto">
        ...
        <p className="font-telugu text-xl md:text-2xl leading-loose text-stone-700">
            మేము, <span className="font-bold text-red-800">కొత్త రామమోహన్ & భవాని </span> మరియు మా ప్రియమైన కుమారుడు <span className="font-bold text-red-800">కొత్తనితిన్ భార్గవ్</span> తో కలిసి, ఆనందం మరియు ఆశలతో నిండిన మా కొత్త గృహంలోకి అడుగుపెడుతున్నాము. ఈ పుణ్యక్షణాన్ని ప్రేమ, నవ్వులు, ఆప్యాయతలు, అలాగే మీ అమూల్యమైన ఆశీస్సులతో మరింత శోభాయమానంగా మార్చుకోవాలని కోరుకుంటున్నాము.
