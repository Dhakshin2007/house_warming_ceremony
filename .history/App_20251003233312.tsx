...
const InvitationSection: React.FC = () => (
    <Section className="py-16 px-6 text-center max-w-4xl mx-auto">
        ...
        <p className="font-telugu text-xl md:text-2xl leading-loose text-stone-700">
            మేము, <span className="font-bold text-red-800">కొత్త రామమోహన్ & భవాని </span> మరియు మా ప్రియమైన కుమారుడు <span className="font-bold text-red-800">కొత్త నితిన్ భార్గవ్</span> తో కలిసి, ఆనందం మరియు ఆశలతో నిండిన మా కొత్త గృహంలోకి అడుగుపెడుతున్నాము. ఈ మధురక్షణాన్ని ప్రేమ, నవ్వులు, ఆప్యాయతలు, అలాగే మీ అమూల్యమైన ఆశీస్సులతో మరింత శోభాయమానంగా మార్చుకోవాలని కోరుకుంటున్నాము.
మీ రాక మాకు అపార ఆనందాన్ని అందించడమే కాక, చిరస్మరణీయంగా మలుస్తుంది. మీ ఆశీర్వాదాలు, అభినందనలు మా గృహానికి శుభవైభవాన్ని, మా హృదయాలకు సంతోషాన్ని కలిగిస్తాయి.
        </p>
        ...
        <p className="font-telugu text-xl md:text-2xl leading-loose text-stone-700 mt-6">
            ...
            <span className="font-bold text-red-800"> శ్రీ సత్యనారాయణ స్వామి వారి వ్రతము</span> నిర్వహించబడుతుంది. 
            అనంతరం <span className="font-bold text-red-800">మధ్యాహ్నం 12:00 గంటలకు</span> విందు ఏర్పాటు చేయబడినది.
        </p>
            <br /><br />
        ...
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-stone-800">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg">8:42Pm onwards</p>
                </div>
                <div className="flex flex-col items-center">
