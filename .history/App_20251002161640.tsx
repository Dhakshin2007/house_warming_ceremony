...
<span className="font-bold text-red-800"></span>గృహప్రవేశ మహోత్సవానికి మీ రాక మాకు అపార ఆనందాన్ని అందించడమే కాక, ఈ ప్రత్యేక దినాన్ని చిరస్మరణీయంగా నిలిపేస్తుంది. మీ సాన్నిధ్యం మా గృహానికి శుభవైభవాన్ని, మా హృదయాలకు సంతోషాన్ని ప్రసాదిస్తుంది.
        </p>
    </Section>
);
