...
const InvitationSection: React.FC = () => (
    <Section className="py-16 px-6 text-center max-w-4xl mx-auto">
        ...
        <p className="font-telugu text-xl md:text-2xl leading-loose text-stone-700">
            మేము, <span className="font-bold text-red-800">Kotha Ramamoharao & Bhavani</span> మరియు మా ప్రియమైన కుమారుడు <span className="font-bold text-red-800">K Nitin Bhargav</span>, మా కొత్త గూటికి మారాము. మేము మా ఇంటిని ప్రేమ, నవ్వు మరియు మీ అమూల్యమైన ఆశీర్వాదాలతో నింపుతున్న ఈ గృహ ప్రవేశ వేడుకలో మీరు మాతో చేరాలని మనస్పూర్తిగా ఆహ్వానిస్తున్నాము. మీ రాక ఈ ప్రత్యేక సందర్భాన్ని చిరస్మరణీయం చేస్తుంది.
        </p>
    </Section>
);
