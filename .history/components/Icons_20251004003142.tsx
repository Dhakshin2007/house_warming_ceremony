...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66C7.32 18.06 9 14 17 12V8z" />
    <path d="M11.5 2C10.12 2 9 3.12 9 4.5S10.12 7 11.5 7 14 5.88 14 4.5 12.88 2 11.5 2z" />
  </svg>
);